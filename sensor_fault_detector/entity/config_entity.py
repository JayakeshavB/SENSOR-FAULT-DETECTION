...
import os
from sensor_fault_detector.constant import training_pipeline
...
class DataIngestPipelineConfig: 
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        ...
        self.testing_file_path: str = os.path.join(
            training_pipeline_config.artifact_dir, training_pipeline.DATA_INGESTION_INGESTED_DIR, training_pipeline.TESTING_FILE_NAME
        ) 
...
class DatavalidationConfig:
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        ...
        self.valid_train_file_path: str = os.path.join(
            self.valid_data_dir, training_pipeline.TRAINING_FILE_NAME
        )
        self.valid_test_file_path: str = os.path.join(
            self.valid_data_dir, training_pipeline.TESTING_FILE_NAME
        )
        self.invalid_train_file_path: str = os.path.join(
            self.invalid_data_dir, training_pipeline.TRAINING_FILE_NAME
        )
        self.invalid_test_file_path: str = os.path.join(
            self.invalid_data_dir, training_pipeline.TESTING_FILE_NAME
        )
