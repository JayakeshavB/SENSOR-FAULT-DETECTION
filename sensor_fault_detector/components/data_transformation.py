from sensor_fault_detector.entity.artifact_entity import DataValidationArtifact, DataTransformationArtifact
from sensor_fault_detector.entity.config_entity import DataTransformationConfig, TrainingPipelineConfig
...
from sensor_fault_detector.utils.main_utils import save_numpy_array_data, save_object
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,) -> DataTransformationArtifact:
        try:
            ...
            logging.info("Starting data transformation: loading data")
